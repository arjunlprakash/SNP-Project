...
boolean newFileFlag;
String fileName;
String applicationTitle="SappEditor";
...
/*void saveFileTemp(File temp){
	...
	FileWriter fout=null;
	File newName1 = new File("C:/Users/Public/Documents/TempSapp/"+str+".txt");
	temp.renameTo(newName1);
	try
	{
	fout=new FileWriter(temp);
	fout.write(npd.ta.getText());
...
try{
	...
	File file = new File("C:/Users/Public/Documents/TempSapp/temp.txt");
...
String applicationName="SappEditor";
...
File file = new File("C:/Users/Public/Documents/TempSapp/temp.txt");
if(file.exists()){
String strMsg="Sapp was not closed properly.<br>"+
		"Do you want to load your previous work?<html>";
int x=JOptionPane.showConfirmDialog(this.f,strMsg,"SappEditor",JOptionPane.YES_NO_CANCEL_OPTION);

if(x==JOptionPane.CANCEL_OPTION){
	try{
		
		File file1 = new File("C:/Users/Public/Documents/TempSapp/temp.txt");
...
try{
BufferedReader br = new BufferedReader(new FileReader("C:/Users/Public/Documents/TempSapp/temp.txt"));
	try {
	    ...
	    try{
	    	...
	    	File file2 = new File("C:/Users/Public/Documents/TempSapp/temp.txt");
...
final String helpAboutNotepad="About SappEditor";

final String aboutText=
	"<html><big>Your SappEditor</big><hr><hr>"
	+"<p align=right>Prepared by a Shivam and Arjun!"
	+"<hr><p align=left>I Used jdk1.7 to compile the source code.<br><br>"
	+"<strong>Thanx 4 using SappEditor.In future we are going to add more functionality.</strong><br>"
	+"Ur Comments as well as bug reports r very welcome at<p align=center>"
	+"<hr><em><big>shivam.pansh.94@gmail.com-arjunprakash95@yahoo.com</big></em><hr><html>";
}